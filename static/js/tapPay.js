...
TPDirect.setupSDK(137041, 'app_YpCfF6vfCOA8fNnCH0HKnSJlfGwctHbVTsMp8FdUkVADXMX6CgOkr1V1Hsos', 'sandbox')
...
function onSubmit(event) {
    ...
    TPDirect.card.getPrime(async(result) => {
        ...
        order = await getBookingData();
        contact = await getUserData();
        primeData = {
            ...
            contact: {"name":contact.data.name, "email": contact.data.email, "phone":inputPhone.value}
        }

        // send prime to your server, to pay with Pay by Prime API .
        fetch(`/api/orders`, {method: "POST", headers: {
